...
from simulation.model import MachineStatus, PrivilegeLevel, PropertyName, VulnerabilityID, VulnerabilityType
from . import model
...
class AgentActions:
    ...
    def __process_outcome(self,
        ...
        if isinstance(outcome, model.LeakedNodesId) and newly_discovered_nodes==0:
            reward -= NEW_SUCCESSFULL_ATTACK_REWARD

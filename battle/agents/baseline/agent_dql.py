...
class DeepQLearnerPolicy(Learner):
    ...
    def __init__(self,
        ...
        self.policy_net.load_state_dict(torch.load('/home/jvy5516/project/battle/model_save/model_chain_100.pth').state_dict())
        self.target_net.load_state_dict(self.policy_net.state_dict())
        self.target_net.eval()
        self.target_update = target_update
        self.save_path = '/home/jvy5516/project/battle/model_save/model_chain_100.pth'
    ...
    def end_of_episode(self, i_episode, t):
        ...
        if i_episode % self.target_update == 0:
            self.target_net.load_state_dict(self.policy_net.state_dict())
        # torch.save(self.policy_net, self.save_path)

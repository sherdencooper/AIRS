...
register(
    ...
    entry_point='_env.cyberbattle_toyctf:CyberBattleToyCtf',
...
register(
    ...
    entry_point='_env.cyberbattle_random:CyberBattleRandom',
)
...
register(
    ...
    entry_point='_env.cyberbattle_chain:CyberBattleChain',
    kwargs={'size': 4,
            'defender_agent': None,
